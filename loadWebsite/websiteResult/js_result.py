...
<script type="text/javascript">
    var radarDom = top.document.getElementById('radar');
    ...
    var gaugeDom = top.document.getElementById('gauge');
    ...
    top.window.addEventListener('resize', gaugeChart.resize);
    top.window.addEventListener('resize', radarChart.resize);
</script>"""
